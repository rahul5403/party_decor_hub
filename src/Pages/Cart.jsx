...
const Cart = () => {
  ...
  // Modified handleQuantityChange function to use removeItem hook consistently
  const handleQuantityChange = useCallback((id, newQuantity) => {
    if (newQuantity > 0) {
      ...
      if (itemToRemove) {
        // Use the same removeItem hook that's used by the delete button
                    ...
                    <tr key={item.product_id} className="hover:bg-gray-50 transition-colors duration-150">
                      ...
                      <td className="py-3 px-4 text-center">
                        <div className="flex items-center justify-center space-x-3">
                          ...
                          <span className="w-10 m-0 text-center font-medium">{item.quantity}</span>
                          <button
        ...
        <span className="block w-16 h-1 bg-green-500 mx-auto mt-2 rounded-full"></span>
          ...
          <div className="bg-white rounded-lg shadow-md overflow-hidden h-fit">
            <div className="p-4 space-y-4">
              ...
              <button
                className="w-full bg-green-500 hover:bg-green-600 text-white font-semibold py-2 px-3 rounded transition-colors duration-200"
                onClick={onCheckout}
              >
                Checkout
              </button>
