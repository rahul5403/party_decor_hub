        ...
        <div className="flex flex-col lg:flex-row gap-4">
          ...
          <div className="hidden lg:block w-60 flex-shrink-0">
            <div className="bg-white rounded-lg shadow-sm p-4 sticky top-2 border border-gray-100 transition-all duration-200 hover:shadow-md">
              ...
              <div className="space-y-2 mt-2">
                {disposableFilterOption.map((item) => (
                  <div 
                    key={item.id} 
          ...
          <div className="flex-1">
            ...
            <div className="hidden sm:flex justify-between items-center mb-4">
              <h2 className="text-2xl font-semibold text-green-800 transition-colors duration-200 hover:text-green-900">Disposable Items</h2>
              <div className="flex items-center gap-2">
                <span className="text-xs text-gray-600 transition-colors duration-200">
                  {disposableItems.length} results
                </span>
            ...
            <div className="sm:hidden flex justify-between items-center mb-3">
              <h2 className="text-lg font-semibold text-gray-800 transition-colors duration-200">Disposable Items</h2>
