...
const DecorBook = () => {
  ...
  const { handleBooking } = useHandleBooking(
    service,
    startDate,
    startTime,
    customerName,
  ...
  return (
    <div
      className={`min-h-screen bg-gray-50 ${
        isFullscreenZoom ? "overflow-hidden" : ""
      }`}
    >
      {isFullscreenZoom && (
      ...
      <div
        className={`max-w-7xl mx-auto px-4 py-8 sm:px-6 lg:px-8 ${
          isFullscreenZoom ? "blur-sm pointer-events-none" : ""
        }`}
      >
              ...
              <div className="space-y-2 w-full">
                ...
                <div className="flex gap-2 items-center w-full">
                  <input
                    ...
                    className="w-full rounded-lg border border-gray-200 py-2 px-3 focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 h-[42px] m-0"
                  />
                  <button
                    type="button"
    ...
    >
      ...
      {expandedSection === index && (
        <div className="p-4 md:p-6 pt-0">
          <div className="text-gray-700 text-base leading-relaxed text-left max-w-none">
            <ReactMarkdown 
